...
# Fetch GEDI shots from postgress for the regions of interest, and save them
# in pkl files.
...
# files. We do this to do subsequent data processing on data frames that are
# as small as possible, to minimize processing time.
#
